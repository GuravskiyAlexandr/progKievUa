...
public class Reflection {
	...
	public static void main(String[] args) {
		...
		Field[] fields = cls.getDeclaredFields(); // получить все поля
		...
		Constructor<?>[] constrs = cls.getConstructors();  // масив обектов описающ пораметры
		...
		try {
			Class<?>[] paramTypes = new Class<?>[] { int.class };//создать констуктор рефлекшен
		...
		try {
			...
			field.setAccessible(true);                                 // делает доступно приватное поле
